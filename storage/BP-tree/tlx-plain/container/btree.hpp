...
// storage/OLC_bskiplist/src/bsl_insert.c and
// storage/RW_bskiplist/src/insert.cpp. Layout must match itemid_t exactly:
// {type, location, next, valid}.
        ...
        else // n->is_leafnode() == true
        {
            ...
            if (!allow_duplicates &&
                ...
                if constexpr (is_pair) {
                    ...
                    tlx_dbx1000_detail::dbx1000_chain_onto(
                        leaf->slotdata[slot].second, value.second);
