...
#define BSKIPLIST_SCAN_BATCH 32

struct BskiplistScanCursor {
	bsl_key_t 	keys[BSKIPLIST_SCAN_BATCH];
	bsl_val_t 	vals[BSKIPLIST_SCAN_BATCH];
...
private:
	...
	BskiplistScanCursor scan_cursor_per_thd[THREAD_CNT];
};